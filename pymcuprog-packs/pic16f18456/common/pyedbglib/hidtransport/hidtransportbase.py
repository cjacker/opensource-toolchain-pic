...
class HidTransportBase(object):
    ...
    def get_matching_tools(self, serial_number_substring='', product=None):
        ...
        :param serial_number: can be an empty string or a subset of a serial number. Not case sensitive
        ...
        if serial_number_substring == None:
        ...
        for device in self.devices:
            if toolname_in_product_string is None or device.product_string.lower().startswith(toolname_in_product_string):
